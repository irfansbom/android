...
public class UploadListAdapter extends SectionedRecyclerViewAdapter<SectionedViewHolder> {
    ...
    public UploadListAdapter(FileActivity parentActivity) {
        ...
        uploadsStorageManager = new UploadsStorageManager(this.parentActivity.getContentResolver(),
        ...
        uploadGroups[0] = new UploadGroup(Type.CURRENT,
                                          UploadListAdapter.this.parentActivity.getString(R.string.uploads_view_group_current_uploads)) {
            @Override
            public void refresh() {
        ...
        uploadGroups[1] = new UploadGroup(Type.FAILED,
                                          UploadListAdapter.this.parentActivity.getString(R.string.uploads_view_group_failed_uploads)) {
            @Override
            public void refresh() {
        ...
        uploadGroups[2] = new UploadGroup(Type.FINISHED,
                                          UploadListAdapter.this.parentActivity.getString(R.string.uploads_view_group_finished_uploads)) {
            @Override
            public void refresh() {
